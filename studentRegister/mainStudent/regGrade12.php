...
$search = $_GET['search'] ?? '';
$params = [];
$search_sql = "WHERE gl.gradelvl_id = 12";
...
<div class="search-bar">
    <form method="GET">
        ...
        <button class="db-btn" type="button" onclick="window.location.href='regGrade12Report.php'"><i class="fas fa-chart-bar"></i> Report</button>
                ...
                if ($result && pg_num_rows($result) > 0) {
                    while ($row = pg_fetch_assoc($result)) {
                        ...
                        echo "<tr>
                                ...
                                <td>$grade</td>
                                <td>
                                    <a href='regGrade12Infos.php?id=$stud_id' class='btn btn-info'><i class='fas fa-eye'></i></a>
                                    </td>
                            </tr>";
                    }
                } else {
