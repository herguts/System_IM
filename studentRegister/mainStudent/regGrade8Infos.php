...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['assign_section'], $_POST['stud_id'])) {
    ...
    header("Location: regGrade8Infos.php?id=" . $stud_id);
    exit;
}
...
<head>
    <meta charset="UTF-8">
    <title>Grade 8 - Student Info</title>
...
<div class="Info">
    <h1> Grade 8 Student Information</h1>
</div>
...
<div class="cards-body">
    <table class="table table-bordered">
        ...
        if ($result && pg_num_rows($result) > 0) {
            ...
            echo "</td>
                <td>
                    <a href='regGrade8Infos.php?delete=$stud_id' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this student?\")'><i class='fas fa-trash-alt'></i></a>
                </td>
            </tr>";
        } else {
