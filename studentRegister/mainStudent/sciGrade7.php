...
$search = $_GET['search'] ?? '';
$params = [];
$search_sql = "WHERE gl.gradelvl_id = 13";
...
<div class="search-bar">
    <form method="GET">
        ...
        <button class="db-btn" type="button" onclick="window.location.href='sciGrade7Report.php'"><i class="fas fa-chart-bar"></i> Report</button>
...
<div class="Info">
    <h1> Grade 7 SSC Student List</h1>
</div>
                ...
                if ($result && pg_num_rows($result) > 0) {
                    while ($row = pg_fetch_assoc($result)) {
                        ...
                        echo "<tr>
                                ...
                                <td>$grade</td>
                                <td>
                                    <a href='sciGrade7Infos.php?id=$stud_id' class='btn btn-info'><i class='fas fa-eye'></i></a>
                                    </td>
                            </tr>";
                    }
                } else {
