...
if (isset($_GET['delete'])) {
    ...
    header("Location: regGrade12.php");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['assign_section'], $_POST['stud_id'])) {
    ...
    header("Location: regGrade12Infos.php?id=" . $stud_id);
    exit;
}
...
<head>
    <meta charset="UTF-8">
    <title>Grade 12 - Student Info</title>
...
<div class="Info">
    <h1> Grade 12 Student Information</h1>
</div>
...
<div class="cards-body">
    <table class="table table-bordered">
        ...
        if ($result && pg_num_rows($result) > 0) {
            ...
            $sectionResult = pg_query($conn, "SELECT section_id, section_name FROM SECTION WHERE gradelvl_id IN (12)");
            ...
            echo "</td>
                <td>
                    <a href='regGrade12Infos.php?delete=$stud_id' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this student?\")'><i class='fas fa-trash-alt'></i></a>
                </td>
            </tr>";
        } else {
