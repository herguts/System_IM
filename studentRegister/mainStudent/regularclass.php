...
<div id="dashboard-cards">
    <a href="grade7.html" style="text-decoration: none; color: inherit;">
        <div class="card" style="background-color:rgb(43, 76, 153);">
            <h5>GRADE 7</h5>
    ...
    <a href="grade8.html" style="text-decoration: none; color: inherit;">
        <div class="card" style="background-color:rgb(43, 76, 153);">
            <h5>Grade 8</h5>
            <div class="content-icon">
                <i class="fa fa-solid fa-list" style="border: 4px solid; padding:4px;"></i>
    ...
    <a href="grade9.html" style="text-decoration: none; color: inherit;">
        <div class="card" style="background-color:rgb(43, 76, 153);">
            <h5>Grade 9</h5>
            <div class="content-icon">
                <i class="fa fa-solid fa-list" style="border: 4px solid; padding:4px;"></i>
    ...
    <a href="grade10.html" style="text-decoration: none; color: inherit;">
        <div class="card" style="background-color:rgb(43, 76, 153);">
            <h5>Grade 10</h5>
            <div class="content-icon">
                <i class="fa fa-solid fa-list" style="border: 4px solid; padding:4px;"></i>
    ...
    <a href="grade11.html" style="text-decoration: none; color: inherit;">
        <div class="card" style="background-color:rgb(43, 76, 153);">
            <h5>Grade 11</h5>
            <div class="content-icon">
                <i class="fa fa-solid fa-list" style="border: 4px solid; padding:4px;"></i>
    ...
    <a href="grade12.html" style="text-decoration: none; color: inherit;">
        <div class="card" style="background-color:rgb(43, 76, 153);">
            <h5>Grade 12</h5>
            <div class="content-icon">
                <i class="fa fa-solid fa-list" style="border: 4px solid; padding:4px;"></i>
