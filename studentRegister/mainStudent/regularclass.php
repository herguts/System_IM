...
<div id="dashboard-cards">
    <a href="regGrade7.php" style="text-decoration: none; color: inherit;">
    ...
    <a href="regGrade8.php" style="text-decoration: none; color: inherit;">
        <div class="card" style="background-color: #87CEEB;">
            <h5>Grade 8</h5>
            <div class="content-icon">
                <i class="fa fa-solid fa-list" style="border: 4px solid; padding:4px;"></i>
    ...
    <a href="regGrade9.php" style="text-decoration: none; color: inherit;">
        <div class="card" style="background-color: #87CEEB;">
            <h5>Grade 9</h5>
            <div class="content-icon">
                <i class="fa fa-solid fa-list" style="border: 4px solid; padding:4px;"></i>
    ...
    <a href="regGrade10.php" style="text-decoration: none; color: inherit;">
        <div class="card" style="background-color: #87CEEB;">
            <h5>Grade 10</h5>
            <div class="content-icon">
                <i class="fa fa-solid fa-list" style="border: 4px solid; padding:4px;"></i>
